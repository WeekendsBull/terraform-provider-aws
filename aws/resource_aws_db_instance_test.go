...
func TestAccAWSDBInstance_ReplicateSourceDb_DeletionProtection(t *testing.T) {
	...
	//
	// An AWS Support case will be opened regarding this.
	// The outcome of that support case will determine next steps for this test or potential workarounds within the resource.
